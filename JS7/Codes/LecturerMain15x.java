...
public class LecturerMain15x {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        LecturerData15x data = new LecturerData15x();
        ...
        while (true) {
            ...
            System.out.println("5. Search Lecturer by Name (SQ)");
            System.out.println("6. Search Lecturer by Age (BS)");
            ...
            switch (choice) {
                case 1:
                    ...
                    Lecturer15x newLecturer = new Lecturer15x(id, name, gender, age);
